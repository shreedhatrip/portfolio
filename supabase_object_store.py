...
SUPABASE_URL = "https://gttdbqaqolwokxcbqcag.supabase.co" # Replace with your Supabase URL
SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd0dGRicWFxb2x3b2t4Y2JxY2FnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTA3MTkxNSwiZXhwIjoyMDg0NjQ3OTE1fQ.rXAvjY62x7ANeMwp1UL_8xmRPTJQXkhAmFiH5nWId5M" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES2UG23CS553.jpg"  # Replace with the local image path
image_name = "PES2UG23CS553.jpg"  # Desired name for the uploaded file
